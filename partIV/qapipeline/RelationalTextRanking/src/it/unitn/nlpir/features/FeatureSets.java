...
import it.unitn.nlpir.features.providers.lists.NERProvider;
...
public class FeatureSets {
	...
	public static FeaturesBuilder buildDKProNEJaccardNESimiliarityFeatures() {
		FeaturesBuilder featureBuilder = new FeaturesBuilder();
		
		featureBuilder.add(new DKProSimilarity(new NERProvider(), new WordNGramJaccardMeasure(1)));
