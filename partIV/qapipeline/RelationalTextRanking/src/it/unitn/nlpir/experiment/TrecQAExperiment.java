...
public class TrecQAExperiment implements Experiment {
	...
	protected void setupFeatures() {
		...
		if (this.featureExtractorClassName!=null){
			...
			logger.info(String.format("Feature extractor: %s", this.featureExtractorClassName));
			IVectorFeatureExtractor vfe = null;
			
				try {
					if (((this.featureCacheFileName==null))){
						Class<?> c = null;
						...
						vfe = (IVectorFeatureExtractor) c.newInstance(this.featureCacheFileName);
					}
